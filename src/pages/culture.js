...
import SendSendedIcon from "../images/button-sended.svg"
...
const CulturePage = () => {
  ...
  const sendEmail = () => {
    ...
    let ACCESS_TOKEN = process.env.ACCESS_TOKEN_SHEET;

    fetch(`https://sheets.googleapis.com/v4/spreadsheets/${SHEET_ID}/values/Newsletter!A2:A3:append?valueInputOption=USER_ENTERED`, {
      method: "POST",
      headers: {
            ...
            <div className="form-email">
              ...
              <div>
                ...
                <div className="send-email">
                  ...
                  <img src={!emailSent ? SendIcon : SendSendedIcon} onClick={sendEmail}/>
                </div>
              </div>
            </div>
